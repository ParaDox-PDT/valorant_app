        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            ...
            colors: List.generate(
              ...
              (index) => hexToColor(agent.backgroundGradientColors![index]),
            ),
          ),
        ),
        child: Material(
          ...
          child: InkWell(
            onTap: () {
              context.push(Routes.agentDetail, extra: agent.uuid);
            },
              ...
              child: Column(
                children: [
                  Text(
                    ...
                    style:
                        AppTypography.st2Regular.copyWith(color: Colors.white),
                  ),
                  8.g,
                  Stack(
                    children: [
                      AgentsImage(
                          image: agent.background ?? 'null',
                          isBackground: true),
