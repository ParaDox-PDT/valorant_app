...
class _WallpapersPageState extends State<WallpapersPage> with WallpapersMixin {
  @override
  Widget build(BuildContext context) => BlocBuilder<WallpapersBloc, WallpapersState>(
    bloc: _bloc,
    buildWhen: (p, c) => p != c,
    builder:
        (__, state) => Scaffold(
                ...
                SliverPadding(
                  ...
                  sliver: SliverList(
                    delegate: SliverChildListDelegate(
                      state.wallpapersStatus == BlocStatus.loading && state.wallpapers.isEmpty
                          ? wallpapersShimmer(context: __)
                          : wallpapersPhotos(
                            context: context,
