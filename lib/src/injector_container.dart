...
void agentsFeature() {
  sl
    ..registerFactory<AgentsBloc>(() => AgentsBloc(sl(), sl()))
    ..registerLazySingleton<AgentsRepository>(() => AgentsRepositoryImpl(dio: sl()));
}

void agentDetailFeature() {
  sl.registerFactory<AgentDetailBloc>(() => AgentDetailBloc(agentsRepository: sl()));
}

void weaponsFeature() {
  sl
    ..registerFactory<WeaponsBloc>(() => WeaponsBloc(sl(), sl()))
    ..registerLazySingleton<WeaponsRepository>(() => WeaponsRepositoryImpl(dio: sl()));
}
...
void ranksFeature() {
  sl
    ..registerFactory<RanksBloc>(() => RanksBloc(ranksRepository: sl(), networkInfo: sl()))
    ..registerLazySingleton<RanksRepository>(() => RanksRepositoryImpl(dio: sl()));
}

void spraysFeature() {
  sl
    ..registerFactory<SpraysBloc>(() => SpraysBloc(spraysRepository: sl(), networkInfo: sl()))
    ..registerLazySingleton<SpraysRepository>(() => SpraysRepositoryImpl(dio: sl()));
}
...
void playerCardsFeature() {
  sl
    ...
    ..registerLazySingleton<PlayerCardsRepository>(() => PlayerCardsRepositoryImpl(dio: sl()));
}

void mapsFeature() {
  sl
    ..registerFactory<MapBloc>(() => MapBloc(mapsRepository: sl(), networkInfo: sl()))
    ..registerLazySingleton<MapsRepository>(() => MapsRepositoryImpl(dio: sl()));
}
...
void wallpapersFeature() {
  sl
    ...
    ..registerLazySingleton<WallpapersRepository>(WallpapersRepositoryImpl.new);
}

void mapDetailFeature() {
  sl.registerFactory<MapDetailBloc>(() => MapDetailBloc(mapsRepository: sl(), networkInfo: sl()));
}
